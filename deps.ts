...
// todo: pin version
export { deepMerge, deepMergeArr } from "https://raw.githubusercontent.com/vwkd/code-web-utilities/main/deep_merge.ts";
export { shallowMerge } from "https://raw.githubusercontent.com/vwkd/code-web-utilities/main/shallow_merge.ts";
export {
    walkChainCall,
    walkChainIdCall,
    walkChainMerge,
    walkChainIdMerge
} from "https://raw.githubusercontent.com/vwkd/code-web-utilities/main/walk_chain.ts";
export {
    walkTreeCall,
    walkTreeLeafCall,
    walkTreeCompare
} from "https://raw.githubusercontent.com/vwkd/code-web-utilities/main/walk_tree.ts";
